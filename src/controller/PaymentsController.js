...
const updatePayment = async (req, res) => {
  ...
  try {
    await PaymentsModel.updatePayment(body, id);
    res.status(200).json({
...
export const PaymentsController = { getAllPayment, getPaymentById, createNewPayment, updatePayment, deleteAllPayment, deletePaymentById };
